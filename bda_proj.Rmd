...
Lecture (See slide 23 of LectureD). Let $y(t)$ denote the number of events that have occurred during a time interval $[0, t]$  
...
Model |  Posterior: $p(\theta~|~y)$ | Named
------|-----------------------------|---------
...
mtext(paste("p-value:", round(pval, 2)), side = 3, cex = 0.75)
