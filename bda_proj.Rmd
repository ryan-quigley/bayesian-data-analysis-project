...
```
```{r, echo = FALSE}
hist(sim.min, right = FALSE, freq = FALSE, ann = FALSE, xlim = c(0,100), ylim = c(0,0.15))
lines(rep(obs.min, 2), c(0, 0.15), col = "red", lwd = 1.5)
...
```
```{r, echo = FALSE}
hist(sim.max, right = FALSE, freq = FALSE, ann = FALSE, xlim = c(0,400), ylim = c(0, 0.12))
lines(rep(obs.max, 2), c(0, 0.12), col = "red", lwd = 1.5)
mtext(paste("p-value =",pval), side = 3)
arrows(obs.max + 5, 0.08, 100, 0.08, code = 1, length = 0.1)
text(100, 0.08, paste("Observed Max =", obs.max), pos = 4)
```

**Conclusion**: 

##### Range of data (INCOMPLETE)
...
```
```{r, echo = FALSE}
hist(sim.range, right = FALSE, freq = FALSE, ann = FALSE, xlim = c(0,400), ylim = c(0,0.08))
lines(rep(obs.range, 2), c(0, 0.08), col = "red", lwd = 1.5)
mtext(paste("p-value:", pval), side = 3)
```

**Conclusion**: 

##### Sample mean (INCOMPLETE)
...
##### Ratio: Sample Mean to Sample Variance (INCOMPLETE)
