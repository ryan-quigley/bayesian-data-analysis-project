...
According to Gelman et. al. (pg. 45), this model is not exchangeable in the $y_i$'s but is exchangeable in the pairs $(t,y)_i$. For our analysis, $\theta$ is the uknown kill rate per hour.
