...
```
```{r, echo = FALSE}
hist(sim.mean, right = FALSE, freq = FALSE, ann = FALSE, xlim = c(40,120), ylim = c(0,0.1))
lines(rep(obs.mean, 2), c(0, 0.1), col = "red", lwd = 1.5)
mtext(paste("p-value:", pval), side = 3)
```
...
```
```{r, echo = FALSE}
hist(sim.var, right = FALSE, freq = FALSE, ann = FALSE, xlim = c(0,400), ylim = c(0,0.015))
lines(rep(obs.var, 2), c(0, 0.015), col = "red", lwd = 1.5)
mtext(paste("p-value:", pval), side = 3)
```
